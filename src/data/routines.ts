...
for (let i = 1; i <= 3; i++) {
  trenSuperior.push({
    ...
    muscles: [{ name: 'Pecho Alto', percentage: 60, type: 'primary' }, { name: 'Hombro', percentage: 25, type: 'secondary' }, { name: 'Tríceps', percentage: 15, type: 'secondary' }]
  });
  trenSuperior.push({
    ...
    muscles: [{ name: 'Dorsal', percentage: 70, type: 'primary' }, { name: 'Bíceps', percentage: 20, type: 'secondary' }, { name: 'Antebrazo', percentage: 10, type: 'secondary' }]
  });
...
for (let i = 1; i <= 3; i++) {
  trenSuperior.push({
    ...
    muscles: [{ name: 'Pecho Medio', percentage: 65, type: 'primary' }, { name: 'Tríceps', percentage: 25, type: 'secondary' }, { name: 'Hombro', percentage: 10, type: 'secondary' }]
  });
  trenSuperior.push({
    ...
    muscles: [{ name: 'Espalda Media', percentage: 70, type: 'primary' }, { name: 'Bíceps', percentage: 20, type: 'secondary' }, { name: 'Lumbar', percentage: 10, type: 'secondary' }]
  });
...
for (let i = 1; i <= 3; i++) {
  trenSuperior.push({
    ...
    muscles: [{ name: 'Bíceps Braquial', percentage: 60, type: 'primary' }, { name: 'Braquiorradial', percentage: 30, type: 'secondary' }, { name: 'Antebrazo', percentage: 10, type: 'secondary' }]
  });
  trenSuperior.push({
    ...
    muscles: [{ name: 'Tríceps', percentage: 80, type: 'primary' }, { name: 'Pecho Frontal', percentage: 10, type: 'secondary' }, { name: 'Hombro', percentage: 10, type: 'secondary' }]
  });
...
trenInferior1.push({
  ...
  muscles: [{ name: 'Cuádriceps', percentage: 70, type: 'primary' }, { name: 'Glúteos', percentage: 20, type: 'secondary' }, { name: 'Core', percentage: 10, type: 'secondary' }]
});
...
trenInferior1.push({
  ...
  muscles: [{ name: 'Cuádriceps', percentage: 80, type: 'primary' }, { name: 'Glúteos', percentage: 15, type: 'secondary' }]
});
...
for (let i = 1; i <= 3; i++) {
  trenInferior1.push({
    ...
    muscles: [{ name: 'Cuádriceps', percentage: 60, type: 'primary' }, { name: 'Glúteo Mayor', percentage: 30, type: 'secondary' }, { name: 'Isquios', percentage: 10, type: 'secondary' }]
  });
...
for (let i = 1; i <= 3; i++) {
  trenInferior1.push({
    ...
    muscles: [{ name: 'Isquiotibiales', percentage: 65, type: 'primary' }, { name: 'Glúteos', percentage: 25, type: 'secondary' }, { name: 'Lumbar', percentage: 10, type: 'secondary' }]
  });
  if (i < 3) trenInferior1.push({ type: 'rest', duration: 90, nextExercise: 'Peso Muerto Rumano' });
}

trenInferior1.push({ type: 'rest', duration: 90, nextExercise: 'Elevación de pantorrillas a una pierna' });

// Bloque 4
for (let i = 1; i <= 3; i++) {
  trenInferior1.push({
    type: 'exercise', title: 'Elevación de pantorrillas a una pierna', reps: '15 reps / pierna', weight: '1x 13.3 kg', notes: 'Sostén la contracción 1s arriba. Baja el talón sintiendo el estiramiento completo. Apoyo pared.', block: 'Bloque 4: Pantorrillas y Abdomen', seriesInfo: `Serie ${i} de 3`,
  ...
  if (i < 3) trenInferior1.push({ type: 'rest', duration: 45, nextExercise: 'Elevación de pantorrillas a una pierna' });
}
...
trenInferior2.push({
  ...
  muscles: [{ name: 'Glúteos', percentage: 40, type: 'primary' }, { name: 'Isquios', percentage: 30, type: 'primary' }, { name: 'Lumbar', percentage: 20, type: 'secondary' }]
});
...
trenInferior2.push({
  ...
  muscles: [{ name: 'Glúteos', percentage: 45, type: 'primary' }, { name: 'Isquios', percentage: 35, type: 'primary' }]
});
...
for (let i = 1; i <= 3; i++) {
  trenInferior2.push({
    ...
    muscles: [{ name: 'Cuádriceps', percentage: 65, type: 'primary' }, { name: 'Glúteos', percentage: 20, type: 'secondary' }, { name: 'Core', percentage: 15, type: 'secondary' }]
  });
...
for (let i = 1; i <= 3; i++) {
  trenInferior2.push({
    ...
    muscles: [{ name: 'Glúteo Mayor', percentage: 50, type: 'primary' }, { name: 'Cuádriceps', percentage: 40, type: 'primary' }, { name: 'Isquios', percentage: 10, type: 'secondary' }]
  });
...
trenInferior2.push({ type: 'rest', duration: 90, nextExercise: 'Elevación de pantorrillas a una pierna' });

// Bloque 4
for (let i = 1; i <= 3; i++) {
  trenInferior2.push({
    type: 'exercise', title: 'Elevación de pantorrillas a una pierna', reps: '15 reps / pierna', weight: '1x 13.3 kg', notes: 'Apoyo en pared. Contrae al máximo arriba (1s) y estira completo al bajar.', block: 'Bloque 4: Pantorrillas y Abdomen', seriesInfo: `Serie ${i} de 3`,
    muscles: [{ name: 'Gemelos', percentage: 90, type: 'primary' }, { name: 'Sóleo', percentage: 10, type: 'secondary' }]
  });
  trenInferior2.push({
  ...
  if (i < 3) trenInferior2.push({ type: 'rest', duration: 45, nextExercise: 'Elevación de pantorrillas a una pierna' });
}
