...
for (let i = 1; i <= 3; i++) {
  ...
  trenSuperior.push({
    type: 'exercise', title: 'Curl de Bíceps', reps: '5 reps', weight: 'Mancuernas | 2x 11.8 kg', notes: i === 1 ? 'El agarre ya descansó, ahora a exigir esos bíceps. Agarre martillo, baja en 3s. Codos fijos a los lados, sin balancear.' : i === 2 ? 'Esos brazos se están poniendo más grandes. No balancees, que el bíceps haga TODO el trabajo ahora que está fresco. Aprieta arriba.' : 'Última serie de curl y de toda la rutina. Para que esos brazos se vean enormes. Cada rep lenta, cada contracción al máximo. Cierra fuerte.', block: 'Bloque 3: Brazos y Hombros', seriesInfo: `Serie ${i} de 3`,
