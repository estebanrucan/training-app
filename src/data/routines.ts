...
for (let i = 1; i <= 3; i++) {
  ...
  trenSuperior.push({
    type: 'exercise', title: 'Elevaciones Laterales', reps: '10 reps', weight: 'Mancuernas | 2x 5.3 kg', notes: i === 1 ? 'Eleva hasta la altura de hombros, codos ligeramente flexionados. Baja en 3s. Que esos deltoides se redondeen.' : i === 2 ? 'Esos hombros se están poniendo anchos. No balancees el torso, deja que el deltoides haga el trabajo. Controla la bajada.' : 'Últimas laterales, que esos hombros queden como bolas. Aprieta arriba y baja lento, siente cada fibra.', block: 'Bloque 3: Brazos y Hombros', seriesInfo: `Serie ${i} de 3`,
